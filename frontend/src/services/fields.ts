...
const mockFields: FieldConfigItem[] = [
  ...
  { id: '33', field_code: 'social_location', field_name: '缴纳地', field_type: 'text', is_required: true, default_required: true, validation_regex: null, validation_msg: null, dropdown_options: null, placeholder: '请输入缴纳地', help_text: null, order_type: 'onboarding', source_category: 'customer_filled', sub_ticket_scope: 'data_entry,social_insurance', collection_group: '基本信息', business_context: ['onboarding'], display_order: 37, is_active: true },
  ...
  { id: 'paper-contract-template', field_code: 'paper_contract_template', field_name: '纸质合同模板名称', field_type: 'text', is_required: false, default_required: false, conditional_required: { op: 'AND', children: [{ op: 'EQ', field: 'need_company_contract', value: '是' }, { op: 'EQ', field: 'need_esign', value: '2.否' }] }, validation_regex: null, validation_msg: null, dropdown_options: null, placeholder: '请输入纸质合同模板名称', help_text: '非电子签劳动合同填写实际使用的纸质合同模板名称', order_type: 'onboarding', source_category: 'agent_supplemented', sub_ticket_scope: 'contract', collection_group: '劳动合同新签', business_context: ['onboarding'], display_order: 55, is_active: true },
