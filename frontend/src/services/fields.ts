...
const mockFields: FieldConfigItem[] = [
  ...
  { id: '54', field_code: 'data_entry_feedback', field_name: '增员报岗录入反馈', field_type: 'dropdown', is_required: false, default_required: false, validation_regex: null, validation_msg: null, dropdown_options: FEEDBACK_OPTIONS, placeholder: '请选择增员报岗录入反馈', help_text: '由增员报岗录入岗在子单完成时填写', order_type: 'onboarding', source_category: 'agent_supplemented', sub_ticket_scope: 'data_entry', collection_group: '社保公积金类', business_context: ['onboarding'], display_order: 54, is_active: true },
