...
import { PAYROLL_LOCATIONS } from '@/constants/payrollLocations';
...
export interface FieldConfigItem {
  ...
  conditional_required?: Record<string, unknown> | null;
...
const mockFields: FieldConfigItem[] = [
  ...
  { id: '14', field_code: 'current_address', field_name: '现住址（文书送达地址）', field_type: 'text', is_required: false, default_required: false, conditional_required: { op: 'EQ', field: 'need_onboarding_contact', value: '否' }, validation_regex: null, validation_msg: null, dropdown_options: null, placeholder: '请输入现住址', help_text: '入职材料不需要集约收集时必填。格式：X省X市X区X路X号X室。提示：如不由外服联系员工收集该信息，则需在本次收集页面填写', order_type: 'onboarding', source_category: 'customer_filled', sub_ticket_scope: 'contract,data_entry', collection_group: '合同与用工信息', business_context: ['onboarding'], display_order: 18, is_active: true },
  { id: '15', field_code: 'household_address', field_name: '户籍地址', field_type: 'text', is_required: false, default_required: false, validation_regex: null, validation_msg: null, dropdown_options: null, placeholder: '请输入户籍地址', help_text: '格式：X省X市X区X路X号X室', order_type: 'onboarding', source_category: 'customer_filled', sub_ticket_scope: 'contract,data_entry', collection_group: '基本信息', business_context: ['onboarding'], display_order: 19, is_active: true },
  { id: '16', field_code: 'postal_code', field_name: '邮编', field_type: 'text', is_required: false, default_required: false, validation_regex: null, validation_msg: null, dropdown_options: null, placeholder: '请输入邮编', help_text: null, order_type: 'onboarding', source_category: 'customer_filled', sub_ticket_scope: 'data_entry', collection_group: '基本信息', business_context: ['onboarding'], is_included_in_template: false, display_order: 20, is_active: true },
  ...
  { id: '18', field_code: 'contract_term', field_name: '合同期限', field_type: 'text', is_required: false, default_required: false, conditional_required: { op: 'NEQ', field: 'contract_term_type', value: '无固定期限' }, validation_regex: null, validation_msg: null, dropdown_options: null, placeholder: '如：2年', help_text: '固定期限时必填', order_type: 'onboarding', source_category: 'customer_filled', sub_ticket_scope: 'contract', collection_group: '基本信息', business_context: ['onboarding'], display_order: 22, is_active: true },
  ...
  { id: '20', field_code: 'contract_end_date', field_name: '合同终止日期', field_type: 'date', is_required: false, default_required: false, conditional_required: { op: 'NEQ', field: 'contract_term_type', value: '无固定期限' }, validation_regex: null, validation_msg: null, dropdown_options: null, placeholder: '请选择合同终止日期', help_text: null, order_type: 'onboarding', source_category: 'customer_filled', sub_ticket_scope: 'contract', collection_group: '基本信息', business_context: ['onboarding'], display_order: 24, is_active: true },
  { id: '21', field_code: 'probation_start_date', field_name: '试用期开始日期', field_type: 'date', is_required: false, default_required: false, validation_regex: null, validation_msg: null, dropdown_options: null, placeholder: '请选择试用期开始日期', help_text: '非必填，可单独填写试用期开始日期', order_type: 'onboarding', source_category: 'customer_filled', sub_ticket_scope: 'contract', collection_group: '基本信息', business_context: ['onboarding'], display_order: 25, is_active: true },
  { id: '22', field_code: 'probation_months', field_name: '试用期（月）', field_type: 'text', is_required: false, default_required: false, validation_regex: null, validation_msg: null, dropdown_options: null, placeholder: '如：3个月', help_text: null, order_type: 'onboarding', source_category: 'customer_filled', sub_ticket_scope: 'contract', collection_group: '基本信息', business_context: ['onboarding'], display_order: 26, is_active: true },
  { id: '23', field_code: 'probation_end_date', field_name: '试用期结束日期', field_type: 'date', is_required: false, default_required: false, validation_regex: null, validation_msg: null, dropdown_options: null, placeholder: '请选择试用期结束日期', help_text: '非必填；填写后按劳动合同期限校验', order_type: 'onboarding', source_category: 'customer_filled', sub_ticket_scope: 'contract', collection_group: '基本信息', business_context: ['onboarding'], display_order: 27, is_active: true },
  ...
  { id: '25', field_code: 'work_hour_system', field_name: '工时制', field_type: 'dropdown', is_required: true, default_required: true, validation_regex: null, validation_msg: null, dropdown_options: options(['标准工时制', '综合工时制', '不定时工时制']), placeholder: '请选择工时制', help_text: null, order_type: 'onboarding', source_category: 'customer_filled', sub_ticket_scope: 'contract', collection_group: '基本信息', business_context: ['onboarding'], display_order: 29, is_active: true },
  ...
  { id: '28', field_code: 'base_salary', field_name: '基本工资', field_type: 'text', is_required: true, default_required: true, validation_regex: null, validation_msg: null, dropdown_options: null, placeholder: '请输入基本工资', help_text: '可填写数字、货币格式或文字说明。', order_type: 'onboarding', source_category: 'customer_filled', sub_ticket_scope: 'contract', collection_group: '基本信息', business_context: ['onboarding'], display_order: 31, is_active: true },
  ...
  { id: '30', field_code: 'probation_salary', field_name: '试用期工资', field_type: 'text', is_required: false, default_required: false, validation_regex: null, validation_msg: null, dropdown_options: null, placeholder: '请输入试用期工资', help_text: '可填写数字、货币格式或文字说明。', order_type: 'onboarding', source_category: 'customer_filled', sub_ticket_scope: 'contract', collection_group: '基本信息', business_context: ['onboarding'], display_order: 33, is_active: true },
  ...
  { id: '33', field_code: 'social_location', field_name: '缴纳地', field_type: 'dropdown', is_required: true, default_required: true, validation_regex: null, validation_msg: null, dropdown_options: null, placeholder: '请选择缴纳地', help_text: '选项来自启用劳动合同主体的城市配置。', order_type: 'onboarding', source_category: 'customer_filled', sub_ticket_scope: 'data_entry,social_insurance', collection_group: '基本信息', business_context: ['onboarding'], display_order: 37, is_active: true },
  ...
  { id: '37', field_code: 'fund_ratio', field_name: '公积金比例', field_type: 'dropdown', is_required: false, default_required: false, validation_regex: null, validation_msg: null, dropdown_options: null, placeholder: '请选择公积金比例', help_text: '根据缴纳地自动加载可选比例。广州、深圳的单位与个人比例可分别选择。', order_type: 'onboarding', source_category: 'customer_filled', sub_ticket_scope: 'data_entry,social_insurance', collection_group: '基本信息', business_context: ['onboarding'], display_order: 41, is_active: true },
  { id: 'o_supplementary_fund_ratio', field_code: 'supplementary_fund_ratio', field_name: '补充公积金比例', field_type: 'dropdown', is_required: false, default_required: false, validation_regex: null, validation_msg: null, dropdown_options: null, placeholder: '请选择补充公积金比例', help_text: '仅当前缴纳地配置了补充公积金比例时显示并可选。', order_type: 'onboarding', source_category: 'customer_filled', sub_ticket_scope: 'data_entry,social_insurance', collection_group: '社保公积金类', business_context: ['onboarding'], display_order: 42, is_active: true },
  ...
  { id: 'o_bank_location', field_code: 'bank_location', field_name: '开户地', field_type: 'text', is_required: false, default_required: false, validation_regex: null, validation_msg: null, dropdown_options: null, placeholder: '请输入开户地', help_text: null, order_type: 'onboarding', source_category: 'agent_supplemented', sub_ticket_scope: 'data_entry', collection_group: '基本信息', business_context: ['onboarding'], display_order: 42, is_active: true },
  { id: '38', field_code: 'bank_name', field_name: '开户银行信息', field_type: 'text', is_required: false, default_required: false, validation_regex: null, validation_msg: null, dropdown_options: null, placeholder: '请输入开户银行信息', help_text: '业务员发起时可空，由入职联系节点补全后回灌', order_type: 'onboarding', source_category: 'agent_supplemented', sub_ticket_scope: 'data_entry', collection_group: '基本信息', business_context: ['onboarding'], display_order: 43, is_active: true },
  ...
  { id: 'o_need_esign', field_code: 'need_esign', field_name: '是否电子签', field_type: 'dropdown', is_required: false, default_required: false, validation_regex: null, validation_msg: null, dropdown_options: options(['1.是', '2.否']), placeholder: '请选择是否电子签', help_text: '当“是否企服发起劳动合同”为是时必填', order_type: 'onboarding', source_category: 'process_judgment', sub_ticket_scope: 'contract', collection_group: '劳动合同新签', business_context: ['onboarding'], display_order: 48, is_active: true },
  ...
  { id: 'special-contract-template-name', field_code: 'special_contract_template_name', field_name: '特殊合同模板名称', field_type: 'text', is_required: false, default_required: false, conditional_required: { op: 'AND', children: [{ op: 'EQ', field: 'need_company_contract', value: '是' }, { op: 'EQ', field: 'contract_template', value: '特殊模板' }] }, validation_regex: null, validation_msg: null, dropdown_options: null, placeholder: '请输入特殊合同模板名称', help_text: '选择特殊模板时填写具体模板名称', order_type: 'onboarding', source_category: 'agent_supplemented', sub_ticket_scope: 'contract', collection_group: '劳动合同新签', business_context: ['onboarding'], display_order: 55, is_active: true },
  { id: '46', field_code: 'need_contract_urge', field_name: '劳动合同签署是否需要催办员工', field_type: 'dropdown', is_required: false, default_required: false, validation_regex: null, validation_msg: null, dropdown_options: YES_NO_OPTIONS, placeholder: '请选择是否需要催办员工', help_text: '当“是否企服发起劳动合同”为是时必填', order_type: 'onboarding', source_category: 'process_judgment', sub_ticket_scope: 'contract', collection_group: '劳动合同新签', business_context: ['onboarding'], display_order: 56, is_active: true },
  ...
  { id: 'o_is_common_template', field_code: 'is_common_template', field_name: '是否使用通用材料', field_type: 'dropdown', is_required: true, default_required: true, validation_regex: null, validation_msg: null, dropdown_options: YES_NO_OPTIONS, placeholder: '请选择是否使用通用材料', help_text: null, order_type: 'onboarding', source_category: 'process_judgment', sub_ticket_scope: 'onboarding_contact', collection_group: '入职联系', business_context: ['onboarding', 'resignation'], display_order: 58, is_active: true },
  { id: 'o_template_name', field_code: 'template_name', field_name: '特殊材料收集内容', field_type: 'text', is_required: false, default_required: false, validation_regex: null, validation_msg: null, dropdown_options: null, placeholder: '请输入特殊材料收集内容', help_text: '选择否时填写额外需要收集的材料，例如学生证、毕业证。', order_type: 'onboarding', source_category: 'agent_supplemented', sub_ticket_scope: 'onboarding_contact', collection_group: '入职联系', business_context: ['onboarding', 'resignation'], display_order: 59, is_active: true },
  ...
  { id: '51', field_code: 'payroll_location', field_name: '发薪地', field_type: 'dropdown', is_required: false, default_required: false, validation_regex: null, validation_msg: null, dropdown_options: options([...PAYROLL_LOCATIONS]), placeholder: '请选择发薪地', help_text: '沿用薪酬银行卡模板的67项发薪地，包含北仑总发薪，独立选择，不与合同主体联动。', order_type: 'onboarding', source_category: 'agent_supplemented', sub_ticket_scope: 'data_entry', collection_group: '发薪信息', business_context: ['onboarding'], display_order: 61, is_active: true },
