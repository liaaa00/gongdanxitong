...
const SEED: ModuleConfigItem[] = [
  ...
  { id: '9', module_code: 'resignation_cert', module_name: '离职证明', parent_module_code: 'resignation_management', module_type: 'sub', display_order: 34, is_active: true, created_at: new Date().toISOString() },
