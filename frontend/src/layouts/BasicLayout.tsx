...
import {
  ...
  BellOutlined, AlertOutlined, InfoCircleOutlined, SoundOutlined,
  ExperimentOutlined,
...
const RAW_MENU: MenuItem[] = [
  ...
  {
    path: '/out-of-province-onboarding-group',
    name: '入职管理',
    icon: <FileTextOutlined />,
    scope: BUSINESS_SCOPE.OUT_OF_PROVINCE,
    children: [
      { path: '/out-of-province/increase', name: '社保公积金增员', key: 'out-of-province-increase' },
    ],
  },
  {
    path: '/out-of-province-offboarding-group',
    name: '离职管理',
    icon: <FileTextOutlined />,
    scope: BUSINESS_SCOPE.OUT_OF_PROVINCE,
    children: [
      { path: '/out-of-province/decrease', name: '社保公积金减员', key: 'out-of-province-decrease' },
    ],
  },
  {
    path: '/out-of-province-in-service-group',
    name: '在职管理',
    icon: <FileTextOutlined />,
    scope: BUSINESS_SCOPE.OUT_OF_PROVINCE,
    children: [
