  ...
  <ErrorBoundary moduleName="路由层">
    <Routes>
      ...
      >
        ...
        <Route path="onboarding/:moduleCode" element={<RoleRoute><RouteGuard moduleName="子工单模块"><OnboardingModule /></RouteGuard></RoleRoute>} />
        ...
        <Route path="renewal" element={<RoleRoute><RouteGuard moduleName="续签管理"><RenewalList /></RouteGuard></RoleRoute>} />
        <Route path="renewal/new" element={<RoleRoute><RouteGuard moduleName="续签新建"><RenewalNew /></RouteGuard></RoleRoute>} />
        <Route path="renewal/:id" element={<RoleRoute><RouteGuard moduleName="续签详情"><RenewalDetail /></RouteGuard></RoleRoute>} />

        <Route path="resignation" element={<RoleRoute><RouteGuard moduleName="离职管理"><ResignationList /></RouteGuard></RoleRoute>} />
        <Route path="resignation/new" element={<RoleRoute><RouteGuard moduleName="离职新建"><ResignationNew /></RouteGuard></RoleRoute>} />
        ...
        <Route path="benefit" element={<RoleRoute><RouteGuard moduleName="待遇申报"><BenefitList /></RouteGuard></RoleRoute>} />
        <Route path="benefit/new" element={<RoleRoute><RouteGuard moduleName="申报新建"><BenefitNew /></RouteGuard></RoleRoute>} />
