...
访问 `http://localhost:5173`，演示管理员账号 `lizhanbo / 123456`；所有 seed 账号默认密码均为 `123456`，`admin123` 为旧口径不可用。
...
后端对 seed 默认密码 `123456` 首次登录会返回 `mustChangePassword=true` 并引导改密；演示前请使用 `lizhanbo / 123456` 或其它 seed 账号，不要使用旧密码 `admin123`。
