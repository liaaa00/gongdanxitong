...
describe('onboarding probation date boundaries without duration inputs', () => {
  ...
  it.each([
    ...
    ['2026-01-01', '2026-12-30', '2026-02-02', false],
    ['2026-01-01', '2027-01-02', '2026-03-01', true],
    ['2026-01-01', '2028-12-30', '2026-03-02', false],
    ['2026-01-01', '2026-12-31', '2026-03-01', true],
    ['2026-01-01', '2028-12-31', '2026-07-01', true],
    ['2026-08-21', '2029-08-20', '2027-02-20', true],
    ['2026-08-21', '2029-08-19', '2027-02-20', false],
    ['2026-08-21', '2029-08-20', '2027-02-22', false],
