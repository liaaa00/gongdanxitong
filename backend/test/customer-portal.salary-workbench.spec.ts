...
describe('CustomerPortalService salary workbench', () => {
  ...
  function fixture() {
    ...
    const service = new CustomerPortalService({} as never, dataSource as never, submissions as never, rules as never, customers as never, {} as never, {} as never, mails as never, {} as never, {} as never, {} as never, {} as never, {} as never, uploads as never, {} as never, {} as never);
