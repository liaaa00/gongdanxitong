...
import { Customer, CustomerAssignee, CustomerPortalAccount, CustomerPortalAccountLink, CustomerPortalRule } from 'src/entities';
...
@Module({
  imports: [TypeOrmModule.forFeature([CustomerPortalAccount, CustomerPortalAccountLink, Customer, CustomerPortalRule, CustomerAssignee]), PortalNotificationsModule],
