...
import { Branch, Customer, CustomerAssignee, CustomerPortalRule, WorkOrder } from 'src/entities';
...
@Module({
  imports: [TypeOrmModule.forFeature([CustomerPortalRule, Customer, CustomerAssignee, WorkOrder, Branch])],
