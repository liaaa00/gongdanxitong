...
export class EnsurePermissionCenterTables20260804004500 implements MigrationInterface {
  name = 'EnsurePermissionCenterTables20260804004500';
  ...
  async down(_queryRunner: QueryRunner): Promise<void> {
    // Preserve permission configuration and audit data if this compatibility migration is reverted.
  }
}
