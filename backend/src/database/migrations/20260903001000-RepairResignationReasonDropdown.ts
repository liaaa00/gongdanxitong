...
export class RepairResignationReasonDropdown20260903001000 implements MigrationInterface {
  name = 'RepairResignationReasonDropdown20260903001000';

  async up(queryRunner: QueryRunner): Promise<void> {
    // The original migration ran before bootstrap seeding, so repair an existing seeded row here.
