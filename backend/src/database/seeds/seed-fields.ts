...
const onboardingFields: FieldSeed[] = [
  ...
  { code: 'contract_end_date',      name: '合同终止日期', type: FieldType.DATE,     required: false, defaultRequired: false, helpText: '标准格式：年-月-日。', conditionalRequired: conditionNotEq('contract_term_type', '无固定期限'), orderType: ONBOARDING, businessContext: [ONBOARDING] },
...
const outOfProvinceFields: FieldSeed[] = [
  {
    ...
    businessContext: [OUT_OF_PROVINCE_INCREASE, OUT_OF_PROVINCE_DECREASE],
  },
];
