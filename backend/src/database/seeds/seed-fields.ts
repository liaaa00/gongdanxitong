...
const onboardingFields: FieldSeed[] = [
  ...
  { code: 'contract_feedback',      name: '劳动合同签订反馈', type: FieldType.DROPDOWN, required: false, defaultRequired: false, options: ['未办', '办理中', '已办结'], orderType: ONBOARDING, businessContext: [ONBOARDING] },
