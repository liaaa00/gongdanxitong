...
const onboardingCollectionGroups: Record<string, string> = Object.fromEntries([
  ...
  ...[
    ...
    'contract_subject', 'company_address', 'project_name', 'work_arrangement', 'contract_template', 'paper_contract_template',
...
const onboardingFields: FieldSeed[] = [
  ...
  { code: 'paper_contract_template', name: '纸质合同模板名称', type: FieldType.TEXT, required: false, defaultRequired: false, helpText: '非电子签劳动合同填写实际使用的纸质合同模板名称。', conditionalRequired: conditionAnd(conditionEq('need_company_contract', '是'), conditionEq('need_esign', '2.否')), orderType: ONBOARDING, businessContext: [ONBOARDING] },
...
const resignationFields: FieldSeed[] = [
  ...
  { code: 'social_pay_region',            name: '缴纳地',           type: FieldType.TEXT,     required: true,  defaultRequired: true,  orderType: RESIGNATION, businessContext: [ONBOARDING, RESIGNATION] },
