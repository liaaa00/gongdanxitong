...
if (-not $FrontendOnly) {
  ...
  Invoke-InDir $Backend 'npm' @('test', '--', '--runTestsByPath', 'test/restore-business-import-migration.spec.ts', 'test/restore-business-create-migration.spec.ts', 'test/restore-province-import-migration.spec.ts', 'test/role-action-permission-baseline.spec.ts', 'test/import-permissions.spec.ts')
