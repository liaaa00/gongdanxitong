...
const STRICT_REQUIRED_FIELD_CODES = new Set(['employee_name', 'id_card_no', 'customer_name', 'customer_code', 'social_insurance_result', 'medical_insurance_result', 'housing_fund_result']);
